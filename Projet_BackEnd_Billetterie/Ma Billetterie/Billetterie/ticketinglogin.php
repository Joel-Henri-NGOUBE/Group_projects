...
// http://localhost:80/exercices-syntaxe1/Log/verify.php
...
$res = $client->request('POST', 'http://localhost:80/Authentification/verify.php',
...
if ($response["Statut"] == "Succès"){
    ...
    if ($response["Message"] == "Identifiants incorrects"){
        ...
        http_response_code(401);
        ?> <div> <p> <?php echo "Veuillez vous connecter à l'espace d'authentification"; ?> </p></div> <?php
    }
}
